...
2. 摄像机类型
  - 透视摄像机（Perspective）：像人眼一样
    - 透视摄像机FOV = 60
    ![透视摄像机FOV=60](/images/log/PerspectiveCameraFOV=60.jpg)
    - 透视摄像机FOV = 20
    ![透视摄像机FOV=20](/images/log/PerspectiveCameraFOV=20.jpg)
    - 透视摄像机FOV = 80
    ![透视摄像机FOV=80](/images/log/PerspectiveCameraFOV=80.jpg)

  - 正交摄像机（Orthographic）：精确而非真实
    - 正交摄像机
    ![正交摄像机](/images/log/OrthographicCamera.jpg)
