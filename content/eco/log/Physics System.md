...
## 核心组件
### [Rigidbody](log/Rigidbody/) / Rigidbody2D
...
### [Collider](log/Collider-and-Trigger) / Collider2D
- 物体的物理形状，用于碰撞检测

### Physics Material / PhysicsMaterial2D
- 用于设置摩擦力、弹力等物理特性  

### [Joint](log/Joint) / Joint2D
...
- 控制器角色不见时使用物理控制，推荐使用[CharacterController](log/Character-Controller/)
